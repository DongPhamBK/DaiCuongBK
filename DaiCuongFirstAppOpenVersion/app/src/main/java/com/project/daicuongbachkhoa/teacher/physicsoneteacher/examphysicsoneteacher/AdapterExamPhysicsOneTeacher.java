...
public class AdapterExamPhysicsOneTeacher extends FirebaseRecyclerAdapter<Exam, AdapterExamPhysicsOneTeacher.ExamViewHolder> {
    ...
    public ExamViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_exam_teacher, parent, false);
    ...
    class ExamViewHolder extends RecyclerView.ViewHolder {
        ...
        public ExamViewHolder(@NonNull View itemView) {
            super(itemView);
            btnNumberExamPhysicsOneTeacher = itemView.findViewById(R.id.btnNumberExamTeacher);
            txtNameExamPhysicsOneTeacher = itemView.findViewById(R.id.txtNameExamTeacher);
            txtTeacherExamPhysicsOneTeacher = itemView.findViewById(R.id.txtTeacherExamTeacher);
            txtDeadlineExamPhysicsOneTeacher = itemView.findViewById(R.id.txtDeadlineExamTeacher);
        }
    }
}
